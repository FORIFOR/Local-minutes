        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {rows.map((ev) => {
              ...
              return (
                <tr key={ev.id} className="border-t border-black/5 dark:border-white/5 hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer" onClick={()=> (location.href = `/meetings/${ev.id}`)}>
